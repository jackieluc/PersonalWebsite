...
loader.load( 'assets/js/threejs/fonts/droid_sans_regular.typeface.json', function ( font ) {
    init( font );
    animate();
} );
...
//    document.body.appendChild( container );
    ...
    earthMesh = new THREE.Mesh(
    	...
    	new THREE.MeshPhongMaterial( {
            map: THREE.ImageUtils.loadTexture( 'assets/js/threejs/images/2_no_clouds_4k.jpg' ),
            bumpMap: THREE.ImageUtils.loadTexture( 'assets/js/threejs/images/elev_bump_4k.jpg' ),
    		bumpScale: 0.5,
    		specularMap: THREE.ImageUtils.loadTexture( 'assets/js/threejs/images/water_4k.png' ),
    ...
    cloudMesh = new THREE.Mesh(
    	...
    	new THREE.MeshPhongMaterial( {
            map: THREE.ImageUtils.loadTexture( 'assets/js/threejs/images/fair_clouds_4k.png' ),
            opacity: 0.8,
            transparent: true,
            depthWrite: false,
        } )
    ...
    starMesh = new THREE.Mesh(
    	...
    	new THREE.MeshBasicMaterial( {
            map: THREE.ImageUtils.loadTexture( 'assets/js/threejs/images/galaxy_starfield.png' ),
            side: THREE.BackSide
        } )
    );
